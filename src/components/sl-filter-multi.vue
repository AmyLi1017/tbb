<template>
    <view>
        <msDropdownMenu>
            <msDropdownItem class="row" v-model="value1" :list="list1" :title="'找活状态'"
            ...
            <msDropdownItem class="row" v-model="value3" :list="list3" :title="'队伍人数'"
                            @change="onValChange"></msDropdownItem>
            ...
            getProvinceChange(value){
                ...
                api.postRegion({level: '',proId: value}).then(res => {
                    if (res.messageId == 1000) {
                      ...
                      _this.multiList = options;
                      console.log(_this.multiList,'isLoadMulti')
                    }
                });
            },
