<template>
    <div class="container">
        ...
        <div class="liBox">
            <div class="name">队伍人数<span class="red">*</span></div>
            <div class="val"><input class="lf" type="number" v-model="population"></div>
            <span class="rt">人</span>
        </div>
        <div class="liBox">
        ...
        methods: {
            ...
            saveInfo(){
                ...
                let mustObj = {
                    ...
                    population: utils.textForm(this.population),
